...
import Loading from "../assets/grocery-assets/components/Loading";
...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="ma-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Breadcrumb */}
        <nav className="flex items-center gap-2 text-sm text-gap-text-light mb-6">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center border border-app-border rounded-xl overflow-hidden">
                  ...
                  <span className="px-5 text-sm font-semibold min-w-[40px]">{displayQuantity}</span>
