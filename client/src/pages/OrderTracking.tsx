              ...
              <div className="bg-white rounded-2xl p-5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-app-text-light captilize">{order.deliveryPartner.vehicleType} • Delivery Partner</p>
                  </div>
                </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5">
              ...
              <div className="mt-4 pt-3 border-t border-app-border space-y-1.5 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-app-text-light">Delivery Free</span>
